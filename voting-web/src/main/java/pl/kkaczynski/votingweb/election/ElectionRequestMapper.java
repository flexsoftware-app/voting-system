...
public class ElectionRequestMapper {
    ...
    ElectionCreateCommand toCommand(ElectionCreateRequest request){
        ...
        return new ElectionCreateCommand(request.name(), request.selectionType(),request.selfVotingPolicy(),request.votingStartsAt(),request.votingEndsAt(),optionCommands);
    };
    ...
    ElectionResponse toResponse(Election election){
        ...
        return new ElectionResponse(election.id(),election.name(),election.selectionType(),election.selfVotingPolicy(),election.votingStartsAt(),election.votingEndsAt(),optionResponses);
    };
